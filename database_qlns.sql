...
CREATE TABLE `nhanvien` (
  ...
  `vai_tro` enum('Admin','Nh̢n vi̻n') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Nh̢n vi̻n',
...
CREATE TABLE `phan_quyen_chuc_nang` (
  `id` int NOT NULL AUTO_INCREMENT,
  `vai_tro` enum('Admin','Nh̢n vi̻n') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
